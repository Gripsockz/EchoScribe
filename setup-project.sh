...
# EchoScribe Project Setup Script
# This script creates a clean Xcode project structure

set -e

echo "🎯 EchoScribe - Project Setup"
echo "============================="

# Create a clean project directory
PROJECT_DIR="EchoScribe-Clean"
echo "📁 Creating clean project directory: $PROJECT_DIR"
...
mkdir -p "$PROJECT_DIR/EchoScribe"

echo "📋 Copying source files..."

# Copy all Swift files recursively
find EchoScribe -name "*.swift" -exec cp {} "$PROJECT_DIR/EchoScribe/" \;

# Copy configuration files
if [ -f "EchoScribe/App/Info.plist" ]; then
    cp "EchoScribe/App/Info.plist" "$PROJECT_DIR/EchoScribe/"
fi

if [ -f "EchoScribe/App/entitlements.mac.plist" ]; then
    cp "EchoScribe/App/entitlements.mac.plist" "$PROJECT_DIR/EchoScribe/"
fi

# Copy CoreData model if it exists
if [ -d "EchoScribe/Core/Database/EchoScribeDataModel.xcdatamodeld" ]; then
    cp -r "EchoScribe/Core/Database/EchoScribeDataModel.xcdatamodeld" "$PROJECT_DIR/EchoScribe/"
fi

# Copy resources if they exist
if [ -d "EchoScribe/Resources" ]; then
    cp -r "EchoScribe/Resources" "$PROJECT_DIR/EchoScribe/"
fi

echo "✅ Files copied successfully!"

# Create a simple Xcode project file
echo "📦 Creating Xcode project..."

cat > "$PROJECT_DIR/EchoScribe.xcodeproj/project.pbxproj" << 'EOF'
// !$*UTF8*$!
{
	archiveVersion = 1;
	classes = {
...
/* Begin PBXBuildFile section */
		...
		1A000021 /* Note.swift in Sources */ = {isa = PBXBuildFile; fileRef = 1A000020 /* Note.swift */; };
		1A000023 /* AudioLevelMeter.swift in Sources */ = {isa = PBXBuildFile; fileRef = 1A000022 /* AudioLevelMeter.swift */; };
		1A000025 /* Info.plist in Resources */ = {isa = PBXBuildFile; fileRef = 1A000024 /* Info.plist */; };
		1A000027 /* entitlements.mac.plist in Resources */ = {isa = PBXBuildFile; fileRef = 1A000026 /* entitlements.mac.plist */; };
...
/* Begin PBXFileReference section */
		...
		1A000020 /* Note.swift */ = {isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = Note.swift; sourceTree = "<group>"; };
		1A000022 /* AudioLevelMeter.swift */ = {isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = AudioLevelMeter.swift; sourceTree = "<group>"; };
		1A000024 /* Info.plist */ = {isa = PBXFileReference; lastKnownFileType = text.plist.xml; path = Info.plist; sourceTree = "<group>"; };
		1A000026 /* entitlements.mac.plist */ = {isa = PBXFileReference; lastKnownFileType = text.plist.entitlements; path = entitlements.mac.plist; sourceTree = "<group>"; };
		1A000028 /* EchoScribe.app */ = {isa = PBXFileReference; explicitFileType = wrapper.application; includeInIndex = 0; path = EchoScribe.app; sourceTree = BUILT_PRODUCTS_DIR; };
...
/* Begin PBXGroup section */
		1A00001A /* EchoScribe */ = {
			...
			children = (
				...
				1A000020 /* Note.swift */,
				1A000022 /* AudioLevelMeter.swift */,
				1A000024 /* Info.plist */,
				1A000026 /* entitlements.mac.plist */,
			);
			path = EchoScribe;
			sourceTree = "<group>";
		};
		1A000027 /* Products */ = {
			isa = PBXGroup;
			children = (
				1A000028 /* EchoScribe.app */,
			);
			name = Products;
			sourceTree = "<group>";
		};
		1A000028 /* EchoScribe-Clean */ = {
			isa = PBXGroup;
			children = (
				1A00001A /* EchoScribe */,
				1A000027 /* Products */,
...
/* Begin PBXNativeTarget section */
		1A000029 /* EchoScribe */ = {
			isa = PBXNativeTarget;
			buildConfigurationList = 1A00002A /* Build configuration list for PBXNativeTarget "EchoScribe" */;
			buildPhases = (
				1A00002B /* Sources */,
				1A000025 /* Frameworks */,
				1A00002C /* Resources */,
			...
			productReference = 1A000028 /* EchoScribe.app */;
			productType = "com.apple.product-type.application";
		};
/* End PBXNativeTarget section */

/* Begin PBXProject section */
		1A00002D /* Project object */ = {
			isa = PBXProject;
			attributes = {
			...
			buildConfigurationList = 1A00002E /* Build configuration list for PBXProject "EchoScribe" */;
			...
			mainGroup = 1A000028 /* EchoScribe-Clean */;
			productRefGroup = 1A000027 /* Products */;
			projectDirPath = "";
			projectRoot = "";
			targets = (
				1A000029 /* EchoScribe */,
...
/* Begin PBXResourcesBuildPhase section */
		1A00002C /* Resources */ = {
			...
			buildActionMask = 2147483647;
			files = (
				1A000025 /* Info.plist in Resources */,
				1A000027 /* entitlements.mac.plist in Resources */,
			);
			runOnlyForDeploymentPostprocessing = 0;
		};
...
/* Begin PBXSourcesBuildPhase section */
		1A00002B /* Sources */ = {
			...
			files = (
				...
				1A000021 /* Note.swift in Sources */,
				1A000023 /* AudioLevelMeter.swift in Sources */,
			);
			runOnlyForDeploymentPostprocessing = 0;
		};
...
/* Begin XCBuildConfiguration section */
		...
		1A000031 /* Debug */ = {
			...
			buildSettings = {
				...
				CODE_SIGN_ENTITLEMENTS = EchoScribe/entitlements.mac.plist;
				...
				INFOPLIST_FILE = EchoScribe/Info.plist;
...
/* Begin XCConfigurationList section */
		1A00002A /* Build configuration list for PBXNativeTarget "EchoScribe" */ = {
		...
		1A00002E /* Build configuration list for PBXProject "EchoScribe" */ = {
			isa = XCConfigurationList;
			buildConfigurations = (
				1A00002F /* Debug */,
				1A000030 /* Release */,
...
/* End XCConfigurationList section */
	...
	rootObject = 1A00002D /* Project object */;
}
EOF

# Create workspace settings
mkdir -p "$PROJECT_DIR/EchoScribe.xcodeproj/project.xcworkspace"
cat > "$PROJECT_DIR/EchoScribe.xcodeproj/project.xcworkspace/contents.xcworkspacedata" << 'EOF'
...
echo "✅ Clean project created successfully!"
echo ""
echo "📱 To open the clean project:"
echo "   open $PROJECT_DIR/EchoScribe.xcodeproj"
echo ""
echo "🚀 Next steps:"
