...
# Simple Xcode Project Creation
echo "🎯 Creating simple Xcode project..."

# Create project directory
PROJECT_DIR="EchoScribe-Simple"
rm -rf "$PROJECT_DIR"
mkdir -p "$PROJECT_DIR"

# Copy all Swift files to a flat structure
find EchoScribe -name "*.swift" -exec cp {} "$PROJECT_DIR/" \;

# Copy configuration files
cp EchoScribe/App/Info.plist "$PROJECT_DIR/"
cp EchoScribe/App/entitlements.mac.plist "$PROJECT_DIR/"

echo "✅ Files copied to $PROJECT_DIR"

# Create a minimal Xcode project
mkdir -p "$PROJECT_DIR/EchoScribe.xcodeproj"
...
/* Begin PBXProject section */
		1A00002D /* Project object */ = {
			...
			mainGroup = 1A000028 /* EchoScribe-Simple */;
...
echo "✅ Simple project created!"
echo "📱 To open: open $PROJECT_DIR/EchoScribe.xcodeproj"
