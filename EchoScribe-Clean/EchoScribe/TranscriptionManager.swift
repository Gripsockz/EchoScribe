...
class TranscriptionManager: ObservableObject {
    ...
    private func formatDetailedNotes(_ transcription: String) -> String {
        let sentences = transcription.components(separatedBy: .sentenceTerminators)
    ...
    private func calculateConfidenceScore(for transcription: String) -> Double {
        ...
        let sentenceCount = transcription.components(separatedBy: .sentenceTerminators).count
